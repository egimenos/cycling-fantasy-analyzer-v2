...
export function TeamSummary({
  ...
  return (
    <div className="space-y-10">
      {/* Success Banner */}
      <div data-testid="roster-complete-banner" className="bg-green-500/10 dark:bg-green-900/20 border-l-4 border-green-500 p-6 rounded-sm flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              >
                ...
                <div className="flex-grow min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {index === 0 && (
                      <span data-testid="roster-captain-badge" className="bg-tertiary/20 text-tertiary text-[10px] px-1.5 font-bold rounded-sm border border-tertiary/30 flex-shrink-0">
                        CAPTAIN
                      </span>
                    )}
                  </div>
          ...
          <div className="bg-surface-container-low p-8 rounded-sm space-y-10 border-t-2 border-primary">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-baseline gap-2">
                <span data-testid="roster-total-score" className="font-headline text-5xl font-black text-on-surface tracking-tighter">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-surface-container-high p-4 rounded-sm">
                ...
                <span data-testid="roster-remaining" className="font-mono text-xl font-bold text-on-surface">
              ...
              <div className="bg-surface-container-high p-4 rounded-sm">
                ...
                <span data-testid="roster-avg-rider" className="font-mono text-xl font-bold text-on-surface">
