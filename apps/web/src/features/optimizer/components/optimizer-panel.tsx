  ...
  return (
    <div data-testid="optimization-panel" className="space-y-10">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end gap-6">
        ...
        <div className="flex items-center gap-8 bg-surface-container-low p-6 rounded-sm">
          <div className="text-right">
            ...
            <div data-testid="optimization-projected-total" className="text-4xl font-mono font-bold text-secondary tracking-tighter">
          ...
          <div className="text-right">
            ...
            <div data-testid="optimization-budget-efficiency" className="text-4xl font-mono font-bold text-tertiary tracking-tighter">
              {efficiency}
      ...
      <div className="flex items-center justify-between">
        <h2 data-testid="optimization-lineup" className="text-xl font-bold font-headline flex items-center gap-2 uppercase tracking-wide">
          Primary Lineup
        </h2>
        <button
