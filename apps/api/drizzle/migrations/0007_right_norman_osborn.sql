...
ALTER TABLE "race_results" ADD CONSTRAINT "race_results_unique" UNIQUE NULLS NOT DISTINCT("rider_id","race_slug","year","category","stage_number","climb_name","sprint_name");